...
def extract_mffc_features(file_path: Path | str, start: int, end: int, n_mfcc: int = 25) -> np.ndarray:
    ...
    mfccs = librosa.feature.mfcc(y=audio_segment, sr=int(info['sample_rate']), n_mfcc=n_mfcc, n_fft=128)
